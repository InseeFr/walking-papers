...
- bump nginx to 1.31.3-alpine
- dependencies:
  - ci: upgrade to latest
  - devs: fix cves
...
- Oidc authentication with extras params (kc_idp_hint)

## [0.1.0](https://github.com/InseeFr/walking-papers/releases/tag/0.1.0) - 2025-11-05
