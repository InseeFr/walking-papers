  ...
  return (
    <UIDialog.Root open={open} onOpenChange={setOpen}>
      ...
      <UIDialog.Portal>
        ...
        <UIDialog.Popup className="fixed z-100 top-1/2 left-1/2 -mt-8 min-w-96 w-auto max-w-[calc(100vw-3rem)] -translate-x-1/2 -translate-y-1/2 rounded-lg bg-gray-50 p-6 text-gray-900 outline outline-gray-200 transition-all duration-150 data-[ending-style]:scale-90 data-[ending-style]:opacity-0 data-[starting-style]:scale-90 data-[starting-style]:opacity-0 dark:outline-gray-300">
